...
namespace SHERIA.Models
{
    ...
    public class MenuHandler
    {
        ...
        {
            string sql = "exec get_menu " + profile_id + ", 'main', ''";
            ...
            if (menudata.Rows.Count > 0)
            {
                for (int i = 0; i <= menudata.Rows.Count - 1; i++)
                {
                    ...
                    sql = "exec get_menu " + profile_id + ", 'sub', '" + menudata.Rows[i]["main_menu_name"].ToString() + "'";
                    ...
                    {
                        menu.menu_url = dbhandler.GetScalarItem("exec get_menu " + profile_id + ", 'page_url', '" + menu.menu_name + "'");
